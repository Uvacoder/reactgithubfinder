...
const Input = ({handleResponse}) => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    className: "container mx-auto flex flex-col items-center justify-center my-2 p-12 bg-white text-gray-900 antialiased"
  }, /* @__PURE__ */ React.createElement("div", {
    className: `b-8 px-6 py-3 border border-gray-200 border-opacity-75 rounded-lg shadow-lg space-x-6 flex items-center w-3/5 hover:shadow-xl ${error ? "border-red-600" : "border-green-500"} border-2 -mt-14`
